...
export default function DirectMessages({
  ...
  const chattingWithReceivedMessages = receivedMessages.filter(
    (message) => message.sender === chattingWithId
  );
  const chattingWithSentMessages = sentMessages.filter(
    (message) => message.receiver === chattingWithId
  );

  const userChat = [
    ...chattingWithReceivedMessages,
    ...chattingWithSentMessages,
  ];
